...
<body>
            ...
            <ul>
                ...
                <li><a href="#">Pages</a>
                    <ul class="header__menu__dropdown">
                        <li><a href="./shop-details.html">Thông tin cửa hàng</a></li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <?php
                            foreach ($getAllLoaiHang as $tenLoaiHang) {
                            ?>
                                <li><a href="#"><?php echo $tenLoaiHang['TenLoaiHang'] ?></a></li>
                            <?php
                            }
                            ?>
                        </ul>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="./img/tauTrenCao2.jpg">
                        <div class="hero__text">
                            <span>Sản phẩm chất lượng cao</span>
                            <h2>Quần áo <br />100% chất liệu tốt</h2>
                            <p>Miễn phí giao hàng với hóa đơn trên 500.000đ</p>
                ...
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="http://localhost/QlBanHang/public/img/product/hoodie-essentiall.png">
                            <h5><a href="#">Hoodie Essentiall</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="http://localhost/QlBanHang/public/img/product/ao-sweater-staytuned.jfif">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            ?>
                                <li class="featured__controls__LH" idLH="<?php echo $loaiHang['IDLoaiHang'] ?>" data-filter=".<?php echo $loaiHang['TenLoaiHang'] ?>"><?php echo $loaiHang['TenLoaiHang'] ?></li>
                            <?php
                            }
                            ?>
                        </ul>
 ...
 <?php include('public/Chung/footer.php') ?>