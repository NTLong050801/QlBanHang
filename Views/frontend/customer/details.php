                ...
                ?>
                    <div class="col-lg-6 col-md-6">
                        <div class="product__details__pic">
                            <div class="product__details__pic__item">
                                <img class="product__details__pic__item--large" src="http://localhost/QlBanHang/public/img/<?=$data_products['img']?>" alt="">
                            </div>
                            <div class="product__details__pic__slider owl-carousel">
                                <img data-imgbigurl="http://localhost/QlBanHang/public/img/<?=$data_products['img']?>" src="http://localhost/QlBanHang/public/img/<?=$data_products['img']?>" alt="">
                                <img data-imgbigurl="http://localhost/QlBanHang/public/img/<?=$data_products['img']?>" src="http://localhost/QlBanHang/public/img/<?=$data_products['img']?>" alt="">
                                <img data-imgbigurl="http://localhost/QlBanHang/public/img/<?=$data_products['img']?>" src="http://localhost/QlBanHang/public/img/<?=$data_products['img']?>" alt="">
                                <img data-imgbigurl="http://localhost/QlBanHang/public/img/<?=$data_products['img']?>" src="http://localhost/QlBanHang/public/img/<?=$data_products['img']?>" alt="">
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="product__details__text">
                            ...
                            <div class="product__details__price">$<?= $data_products['DonGiaBan']?></div>
