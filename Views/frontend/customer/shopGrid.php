            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <?php
                            foreach ($getAllLoaiHang as $AllloaiHang) {
                            ?>
                                <li><a href="#"><?php echo $AllloaiHang['TenLoaiHang']?></a></li>
                            <?php
                            }
                            ?>
                        </ul>
                        ...
                        <div class="row">
                            <div class="product__discount__slider owl-carousel">
                                <div class="col-lg-4">
                                    ...
                                    <?php
                                        foreach ($spBanChay as $spBanChay1) {
                                        ?>
                                            <div class="product__discount__item__pic set-bg" data-setbg="http://localhost/QlBanHang/public/img/product/<?= $spBanChay1['img']?>">
                                            ...
                                            <div class="product__discount__item__text">
                                                <span><?= $spBanChay1['IDLoaiHang']?></span>
                                                <h5><a href="#"><?= $spBanChay1['TenSP']?></a></h5>
                                                <div class="product__item__price"><?= $spBanChay1['DonGiaBan']?></div>
                                            </div>
                                        <?php
                                        }
                                        ?>
