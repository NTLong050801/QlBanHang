...
<body>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="https://media.istockphoto.com/photos/luxury-clothing-store-with-clothes-shoes-and-other-personal-picture-id1308246727?s=612x612">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            <a href="http://localhost/QlBanHang/index.php?controller=customer#">Home</a>
                            <span>Shop</span>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="product__discount__item">
                                            ...
                                            <div class="product__discount__item__text">
                                                ...
                                                <h5><a href="#"><?= $top_sanphams['TenSP'] ?></a></h5>
